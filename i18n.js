(() => {
    ...
    const ENGLISH_TRANSLATIONS = [
        ...
        ["Contacto", "Contact"],
        ["Servicios", "Services"],
        ["Servicio institucional", "Institutional service"],
        ["Gestión institucional en una sola órbita.", "Institutional management in a single orbit."],
        ["Astropedia reúne las herramientas, servicios, contactos y oportunidades de las organizaciones afiliadas a Red Astrum en un portal privado y seguro.", "Astropedia brings together the tools, services, contacts, and opportunities available to Red Astrum member organizations in one private and secure portal."],
        ["Ingresar a Astropedia", "Open Astropedia"],
        ["Ingresar al servicio Astropedia", "Open the Astropedia service"],
